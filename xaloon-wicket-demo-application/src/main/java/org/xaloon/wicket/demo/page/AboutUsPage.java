...
import org.xaloon.wicket.demo.panel.AboutUsPanel;

/**
 * @author vytautas r.
 *
 */
@MountPage(value="/about-us", order=50)
public class AboutUsPage extends LayoutWebPage {
