...
import org.xaloon.wicket.demo.panel.HotToursPanel;

/**
 * @author vytautas r.
 *
 */
@MountPage(value="/hot-tours", order=60)
public class HotToursPage extends TravelGroupPage {
