...
import org.xaloon.wicket.demo.panel.HotelsPanel;

/**
 * @author vytautas r.
 *
 */
@MountPage(value="/hotels", order=50)
public class HotelsPage extends TravelGroupPage {
