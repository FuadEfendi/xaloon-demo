...
import org.xaloon.wicket.component.custom.panel.MessagePanel;
 ...
 *
 */
@MountPageGroup(value = "/contact", plugin = EmailPlugin.class, order = 70)
@MountPage(value = "/")
public class ContactUsPage extends LayoutWebPage {
